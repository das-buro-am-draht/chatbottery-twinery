...
/*	expect(created['chapbook-1.2.1']).to.exist;
		...
		expect(created['Harlowe-3.2.3']).to.exist;
		expect(created['Harlowe-3.2.3'].url).to.equal(
			'story-formats/harlowe-3.2.3/format.js'
		);
		expect(created['Harlowe-3.2.3'].userAdded).to.be.false;
		expect(created['Harlowe-2.1.0']).to.exist;
