...
export const publishStoryWithFormat = (appInfo, story, format, formatOptions, startId) => {
...
export const publishArchive = (stories, appInfo) => {
	return stories.reduce(
		(output, story) => {
			...
			return (
				output +
				publishStory(appInfo, story, null, null, true) +
				"\n\n"
			);
		},
...
export const publishStory = (appInfo, story, formatOptions, startId, startOptional) => {
...
export const publishPassage = (passage, localId) => {
	return (
